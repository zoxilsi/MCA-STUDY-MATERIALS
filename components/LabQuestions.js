function LabQuestions({ course }) {
  ...
  const labCourses = {
    ...
    "20MCA133": {
      ...
      description:
        "Build stunning websites with modern web technologies and frameworks",
    ...
    "20MCA136": {
      ...
      gitlabRepo:
        "https://gitlab.com/zoxilsi/computer-network-and-system-administrtion",
    },
  };
    ...
    const modules = [
      {
        ...
        files: [
          {
            name: "Python.pdf",
            path: "https://drive.google.com/uc?export=download&id=1xYNbAFwheESwjtMx84u5KaPIjO1Eac9A",
          },
          {
            name: "Tuples and Dictionary.pdf",
            path: "https://drive.google.com/uc?export=download&id=1cTlqwN1Kw9fFHDSuIvUZ3_3bY-UFylQd",
          },
          {
            name: "OOPs Intro.pdf",
            path: "https://drive.google.com/uc?export=download&id=1ssR5CCVWX2VslkubHE7qJzdIZHUyGsuD",
          },
          {
            name: "Class Part 1.pdf",
            path: "https://drive.google.com/uc?export=download&id=1UJhXTiZS9g13-uVzUiwc7Nlfr6mCtmI6",
          },
          {
            name: "Class Part 2.pdf",
            path: "https://drive.google.com/uc?export=download&id=16DsmJlEMQFzGzWb8QkLaDPJ63O4V8xX5",
          },
          {
            name: "Polymorphism.pdf",
            path: "https://drive.google.com/uc?export=download&id=1d1mNjSC9vt-5ufo3qNABInNnMvVHkJCT",
          },
          {
            name: "Abstract Class.pdf",
            path: "https://drive.google.com/uc?export=download&id=1502AadJB_t1HJmnb0JZTlJ3A-RyGvK0X",
          },
          {
            name: "File Handling.pdf",
            path: "https://drive.google.com/uc?export=download&id=1yfe2C4x4KbBr6aN3ULd62ZnD9tsMRoTa",
          },
          {
            name: "Regular Expression.pdf",
            path: "https://drive.google.com/uc?export=download&id=1Jtm3Fl4UDkt9UJGYak2TGXZe9dGBhyz_",
          },
          {
            name: "CSV.pdf",
            path: "https://drive.google.com/uc?export=download&id=1Agog0G6UphqWLlxcqzDhm6RcArmOmEAT",
          },
        ],
      },
    ];
        ...
        files: [
          {
            ...
            path: "https://drive.google.com/uc?export=download&id=1wAlQC_SGj6nfCb6SVTOg9fhT00RdkHlv",
          },
          {
            name: "HTML Hyperlink",
            path: "https://drive.google.com/uc?export=download&id=1qS_ZmCGpUBkpn4z3xB-VFhaIYShbrg4M",
          },
          {
            name: "HTML Part 3",
            path: "https://drive.google.com/uc?export=download&id=1LiN9yQHuo8QA2pGcLGmUAjMTTwWOtqWH",
          },
          {
            name: "Font & Background",
            path: "https://drive.google.com/uc?export=download&id=16T9jerIfXaZ8aalMcgJC4_IstNIYZTIg",
          },
          {
            name: "HTML Forms",
            path: "https://drive.google.com/uc?export=download&id=1P2qeERTX8wGzRdDOUui_VAXrngh1bPMK",
          },
          {
            name: "Iframes",
            path: "https://drive.google.com/uc?export=download&id=15mMHZWFzw5tnhQil3yvBluZGwnTID-zg",
          },
          {
            name: "CSS Introduction",
            path: "https://drive.google.com/uc?export=download&id=1ak1rvNMlOF63mG1r_ZlpEeADwChC-3x6",
          },
          {
            name: "JavaScript Introduction",
            path: "https://drive.google.com/uc?export=download&id=1wtUxI9fNBgl-Fb65YL1INcgW9JX9VOp_",
          },
          {
            name: "JavaScript Objects",
            path: "https://drive.google.com/uc?export=download&id=1PHLMlizgIyWFxYMwCm8-iVyGb8zOqF1-",
          },
          {
            name: "JavaScript Validation",
            path: "https://drive.google.com/uc?export=download&id=1uj33PMjtTUL-upiCQSZZkgsi1A0Ac0MA",
          },
          {
            name: "PHP Basics",
            path: "https://drive.google.com/uc?export=download&id=1L0nJ2TWS49hL0Ee9N-hSCSCn6sSd-HsB",
          },
          {
            name: "PHP Operators",
            path: "https://drive.google.com/uc?export=download&id=1JH_3mndp5y2Cii87JSthW7HQ1TqT5MxW",
          },
          {
            name: "Array",
            path: "https://drive.google.com/uc?export=download&id=1cif-lW1lF5betGA_ADX8sSFxyC9gEiNq",
          },
          {
            name: "MySQL",
            path: "https://drive.google.com/uc?export=download&id=1LA9iXIzbCPNi8UlK9MCnoQTZ8D40nwF2",
          },
        ],
      },
    ];
      ...
      <div className={`min-h-screen ${lab.bgColor} ${lab.darkBgColor} py-16`}>
        <div className={`max-w-4xl mx-auto px-6 pt-12 pb-6`}>
          <div className="flex items-center gap-4 mb-8">
            <div
              className={`w-14 h-14 bg-gradient-to-r ${lab.color} rounded-lg border-3 border-black shadow-[3px_3px_0px_0px_rgba(0,0,0,0.9)] flex items-center justify-center`}
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl p-4 border-3 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,0.9)] mb-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <div className="flex flex-col md:flex-row gap-4 mt-6">
            <button
              ...
              onClick={() =>
                window.open(
                  "https://github.com/zoxilsi/KTU_MCA_LAB_WORK",
                  "_blank"
                )
              }
            >
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "mailto:24mp2275@rit.ac.in?subject=Lab Notes for " +
                    course.code,
                  "_blank"
                )
              }
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                Find all lab exercises, solutions, and code examples
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300 mt-2">
                Alternative repository with CI/CD pipelines
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16">
      ...
      <p className="text-lg text-gray-600 dark:text-gray-300 mb-6 text-center max-w-md">
        We're working hard to bring you comprehensive lab questions for{" "}
      ...
      <div className="flex gap-4 flex-wrap justify-center">
        <button
          ...
          onClick={() =>
            window.open("https://github.com/mca-website/contribute", "_blank")
          }
        >
        ...
        <button
          ...
          onClick={() =>
            window.open(
              "mailto:contact@mca-website.com?subject=Lab Questions Request for " +
                course.code,
              "_blank"
            )
          }
      ...
      <div className="mt-8 p-4 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-gray-300 dark:border-gray-700 max-w-md">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">
          Our lab questions are created by students, for students! Each question
          is carefully crafted to make learning easier and more engaging.
        </p>
      </div>
    </div>
  );
