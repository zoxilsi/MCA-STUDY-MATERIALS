  ...
  try {
    ...
    return (
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6" data-name="progress-stats" data-file="components/ProgressStats.js">
        <div className="p-4 rounded-xl border-2 shadow-[4px_4px_0px_0px_rgba(0,0,0,0.9)] bg-white dark:bg-gray-800 border-black dark:border-gray-600 hover:scale-[1.02] hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.9)] transition-transform duration-200">
